...
mongoClient.open(function(err, mongoClient) {
    db = mongoClient.db("voicemail");
    db.collection(collectionName, {strict:true}, function(err, collection) {
        if (err) {
            console.log("The 'subscriptions' collection doesn't exist. Creating it with sample data...");
...
var dummySubscriptions = function() {
    console.log("creating dummy subcriptions for testing");
    
    var subscriptions = [
        {"id" : "1111111111", "notifyURL" : [ {"url": "www.nofiyme", "added": "today"}]},
        {"id" : "2222222222", "notifyURL" : [ {"url": "www.nofiyme", "added": "today"}]},
        {"id" : "3333333333", "notifyURL" : [ {"url": "www.nofiyme", "added": "today"}]}
    ];
